...
export function Contact() {
  return (
    <section id="kontakt" className="py-20 md:py-28 bg-white relative overflow-hidden">
      {/* Decorative shapes */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 xl:gap-24">
          <div>
            ...
            <p className="text-lg text-brand-dark/80 leading-relaxed mb-10 md:mb-12">
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-medium text-brand-dark text-lg mb-1">Telefon</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-medium text-brand-dark text-lg mb-1">E-Mail</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-medium text-brand-dark text-lg mb-1">Donnerstag</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-medium text-brand-dark text-lg mb-1">Freitag & Samstag</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-medium text-brand-dark text-lg mb-1">Sonntag - Mittwoch</h3>
                  <p className="text-brand-dark/70">
            ...
            <div className="mt-12 flex gap-4">
              <a href="#" className="w-12 h-12 rounded-full bg-brand-cream flex items-center justify-center text-brand-dark hover:bg-brand-turquoise hover:text-white transition-colors border border-brand-turquoise/20">
          ...
          <div className="bg-brand-cream rounded-[3rem] p-10 lg:p-14 shadow-sm relative">
            {/* Decorative corner */}
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-brand-turquoise/20 rounded-full -z-10"></div>
            
            <h3 className="text-3xl font-serif font-medium text-brand-dark mb-8">Nachricht senden</h3>
