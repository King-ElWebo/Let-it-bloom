...
export function PrivateHomeShopping() {
  return (
    <section className="py-20 md:py-28 bg-brand-cream relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="bg-white rounded-[3rem] p-12 lg:p-16 border border-brand-turquoise/10 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 xl:gap-24 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-semibold text-brand-dark mb-8">
              ...
              <a href="#kontakt" className="inline-block px-8 py-4 bg-brand-turquoise text-white text-base font-medium rounded-full hover:bg-brand-turquoise/90 transition-colors shadow-sm hover:-translate-y-0.5">
                Termin vereinbaren
              </a>
            </div>
