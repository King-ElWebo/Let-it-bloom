            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6 h-[280px] sm:h-[320px] md:h-[420px] lg:h-[520px]">
              <div className="grid grid-rows-2 gap-4 md:gap-6 min-h-0">
                <div className="relative rounded-3xl overflow-hidden shadow-sm min-h-0">
                  <Image src="/images/private/WhatsApp Image 2026-04-26 at 13.38.23.jpeg" fill sizes="(max-width: 1024px) 50vw, 25vw" className="object-cover" alt="Floristin berät" />
                </div>
                <div className="relative rounded-3xl overflow-hidden shadow-sm min-h-0">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-sm">
                <Image src="/images/WhatsApp Image 2026-04-09 at 06.44.03 (1).jpeg" fill sizes="(max-width: 1024px) 50vw, 25vw" className="object-cover" alt="Pflanzen im Zuhause" />
              </div>
            </div>
          </div>
        </div>
