  ...
  return (
    <section className="relative pt-24 pb-16 sm:pt-28 sm:pb-20 md:pt-32 md:pb-24 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="mb-6 sm:mb-8 inline-flex flex-col items-center relative">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-serif italic text-brand-dark/90 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
          Ihr mobiler Blumen- & Pflanzenhändler im Weinviertel
        </h1>
        
        <p className="text-sm sm:text-base md:text-lg text-brand-dark/70 mb-10 sm:mb-12 max-w-xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <a
            ...
            className="w-full sm:w-auto px-7 py-3.5 sm:px-8 sm:py-4 bg-brand-turquoise text-white text-sm sm:text-base font-medium rounded-full hover:bg-brand-turquoise/90 transition-all shadow-sm hover:shadow-md hover:-translate-y-1"
          >
            Anrufen
          </a>
          <a
            href="#kontakt"
            className="w-full sm:w-auto px-7 py-3.5 sm:px-8 sm:py-4 bg-brand-cream border-2 border-brand-turquoise/30 text-brand-dark text-sm sm:text-base font-medium rounded-full hover:border-brand-turquoise hover:bg-brand-turquoise/5 transition-all hover:-translate-y-1"
          >
            Kontakt aufnehmen
          </a>
        </div>
